...
def test_fast_gaussian(
    ...
    Ex_pw, Ey_pw, Ez_pw = focused_gauss(lambda_vac=lambda_vac, n_bfp=n_bfp, n_medium=n_medium, 
    ...
    Ex_czt, Ey_czt, Ez_czt = fast_gauss(lambda_vac=lambda_vac, n_bfp=n_bfp, n_medium=n_medium, 
                                              focal_length=focal_length, NA=NA, filling_factor=filling_factor, 
