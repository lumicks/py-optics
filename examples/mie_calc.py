...
# %%
Ex, Ey, Ez, X, Y, Z = mie.fields_in_focus(n_BFP=1.0, focal_length=4.43e-3, NA=1.2, x=x, y=0, z=z, 
...
# %%
Ex, Ey, Ez, X, Y, Z = mie.fields_in_focus(n_BFP=1.0, focal_length=4.43e-3, NA=.9, x=0, y=y, z=z, 
...
# %%
Ex, Ey, Ez, X, Y, Z = mie.fields_in_focus(n_BFP=1.0, focal_length=4.43e-3, NA=.01, x=x, y=0, z=z, 
                                         bead_center=(0,0,0), bfp_sampling_n=9, return_grid=True)
...
# %%
Ex, Ey, Ez, X, Y, Z = mie.fields_in_focus(n_BFP=1.0, focal_length=4.43e-3, NA=.9, x=x, y=0, z=z, 
